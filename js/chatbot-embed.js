...
`});var m,M=g(()=>{I();m={chatbot:null,fab:null,root:null,isInline:!1,inject(c){let t=c.width||380,e=c.height||650;this.isInline=c.mode==="inline";let o=document.createElement("div");o.id="malgn-tutor-host",this.isInline&&(o.style.cssText="display:block;width:100%;height:100%;");let i=o.attachShadow({mode:"open"});this.root=i;let s=document.createElement("style");s.textContent=L,i.appendChild(s);let n=document.createElement("link");if(n.rel="stylesheet",n.href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css",i.appendChild(n),!this.isInline){let r=document.createElement("button");r.id="malgn-fab",r.className="chat-fab",r.title="\uCC44\uD305 \uC5F4\uAE30",r.innerHTML=`
        <i class="bi bi-chat-dots-fill chat-fab-icon"></i>
        <i class="bi bi-x-lg chat-fab-close"></i>
      `,i.appendChild(r),this.fab=r}let a=document.createElement("div");if(a.id="malgn-chatbot",this.isInline?a.className="chatbot chatbot--inline":(a.className="chatbot",a.hidden=!0,a.style.width=t+"px",a.style.height=e+"px"),a.innerHTML=`
      <!-- Header -->
...
`);return t.forEach((l,h)=>{r=r.replace(`\0CODEBLOCK${h}\0`,l)}),o.forEach((l,h)=>{r=r.replace(`\0INLINE${h}\0`,l)}),r}function v(c){return c.replace(/\*{3}(.+?)\*{3}/g,"<strong><em>$1</em></strong>").replace(/\*{2}(.+?)\*{2}/g,"<strong>$1</strong>").replace(/__(.+?)__/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/(?<!\w)_(.+?)_(?!\w)/g,"<em>$1</em>")}var z=g(()=>{});var q,$=g(()=>{z();q=class{constructor(t,e,o){this.api=t,this.config=e,this.root=o,this.sessionId=null,this.isLoading=!1,this.onSessionCreating=null,this.onSessionCreated=null}init(){this.messagesEl=this.root.querySelector("#malgn-messages"),this.inputEl=this.root.querySelector("#malgn-input"),this.sendBtn=this.root.querySelector("#malgn-send"),this.sendBtn.addEventListener("click",()=>this.sendMessage()),this.inputEl.addEventListener("keydown",t=>{t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),this.sendMessage())}),this.inputEl.addEventListener("focus",()=>this.scrollToBottom())}async loadSession(t){this.sessionId=t;try{let e=await this.api.getSession(t);e.success&&(this.clearMessages(),(e.data.messages||[]).forEach(i=>{i.role==="user"?this.addUserMessage(i.content):this.addAssistantMessage(i.content)}),this.onSessionLoaded&&this.onSessionLoaded(e.data))}catch(e){console.error("\uC138\uC158 \uB85C\uB4DC \uC2E4\uD328:",e)}}clearMessages(){this.messagesEl.innerHTML=""}async ensureSession(){if(this.sessionId)return this.sessionId;this.onSessionCreating&&this.onSessionCreating();let t=await this.api.createSession(this.config.contentIds||[],{courseId:this.config.courseId,courseUserId:this.config.courseUserId,lessonId:this.config.lessonId,userId:this.config.userId,settings:this.config.settings,parentSessionId:this.config.parentSessionId});return t.success&&(this.sessionId=t.data.session.id,this.onSessionCreated&&this.onSessionCreated(t.data)),this.sessionId}async sendMessage(t){let e=t||this.inputEl.value.trim();if(!(!e||this.isLoading)){this.inputEl.value="",this.addUserMessage(e),this.setLoading(!0);try{await this.ensureSession();let o=document.createElement("div");o.className="chatbot-msg chatbot-msg--assistant chatbot-msg--typing";let i=document.createElement("div");i.className="chatbot-msg-content",i.innerHTML='<span class="chatbot-typing-dot"></span><span class="chatbot-typing-dot"></span><span class="chatbot-typing-dot"></span>',o.appendChild(i),this.messagesEl.appendChild(o),this.scrollToBottom();let s="",n=!1;await this.api.sendMessageStream(e,this.sessionId,this.config.settings||{},a=>{n||(n=!0,o.classList.remove("chatbot-msg--typing"),i.textContent=""),s+=a,i.textContent=s,this.scrollToBottom()},a=>{i.innerHTML=w(s),this.scrollToBottom(),this.setLoading(!1)},a=>{console.error("\uC2A4\uD2B8\uB9AC\uBC0D \uC2E4\uD328:",a),n||(i.textContent=""),i.innerHTML=w(s||"\uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4: "+a.message),this.setLoading(!1)})}catch(o){console.error("\uBA54\uC2DC\uC9C0 \uC804\uC1A1 \uC2E4\uD328:",o),this.addAssistantMessage("\uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4: "+o.message),this.setLoading(!1)}}}addUserMessage(t){let e=document.createElement("div");e.className="chatbot-msg chatbot-msg--user",e.innerHTML=`<div class="chatbot-msg-content">${b(t)}</div>`,this.messagesEl.appendChild(e),this.scrollToBottom()}addAssistantMessage(t){let e=document.createElement("div");e.className="chatbot-msg chatbot-msg--assistant",e.innerHTML=`<div class="chatbot-msg-content">${w(t)}</div>`,this.messagesEl.appendChild(e),this.scrollToBottom()}addTypingIndicator(){if(this.root.querySelector("#malgn-typing"))return;let t=document.createElement("div");t.id="malgn-typing",t.className="chatbot-msg chatbot-msg--assistant chatbot-msg--typing",t.innerHTML=`
    ...
    `;if(s)e.options.forEach((h,d)=>{let p=d+1,u=this.answers[e.id]===String(p);n+=`
    ...
    `,t.innerHTML=n,t.querySelectorAll(".chatbot-quiz-option").forEach(h=>{h.addEventListener("click",()=>{this.answers[h.dataset.quizId]=h.dataset.answer,this.renderCurrentQuiz()})});let a=this.root.querySelector("#malgn-prev-quiz"),r=this.root.querySelector("#malgn-next-quiz"),l=this.root.querySelector("#malgn-check-answer");a&&a.addEventListener("click",()=>this.prev()),r&&r.addEventListener("click",()=>this.next()),l&&l.addEventListener("click",()=>this.checkAnswer())}prev(){this.currentIndex>0&&(this.currentIndex--,this.renderCurrentQuiz())}next(){this.currentIndex<this.quizzes.length-1&&(this.currentIndex++,this.renderCurrentQuiz())}checkAnswer(){let t=this.quizzes[this.currentIndex],e=this.answers[t.id],o=this.root.querySelector("#malgn-quiz-result");if(!o)return;if(!e){o.className="chatbot-quiz-result",o.innerHTML='<span class="text-warning">\uB2F5\uC744 \uC120\uD0DD\uD574 \uC8FC\uC138\uC694.</span>',o.style.display="block";return}this.attempts[t.id]=(this.attempts[t.id]||0)+1;let i=this.attempts[t.id],s=e===t.answer,n=s?"chatbot-result-correct":"chatbot-result-wrong",a=s?"bi-check-circle-fill":"bi-x-circle-fill",r=s?"\uC815\uB2F5\uC785\uB2C8\uB2E4.":"\uC624\uB2F5\uC785\uB2C8\uB2E4.";o.className=`chatbot-quiz-result ${s?"correct":"wrong"}`;let l=`
      <div class="${n}">
        <i class="bi ${a} chatbot-result-icon"></i>${r}
      </div>
    `;if(!s&&i===1&&(l+='<div class="chatbot-result-explanation">\uB2E4\uC2DC \uD55C \uBC88 \uB3C4\uC804\uD574 \uBCF4\uC138\uC694!</div>'),(s||i>=2)&&t.explanation&&(l+=`<div class="chatbot-result-explanation"><strong>\uD574\uC124:</strong> ${b(t.explanation)}</div>`),o.innerHTML=l,o.style.display="block",s||i>=2){this.checked[t.id]=!0;let h=this.root.querySelector("#malgn-next-quiz"),d=this.root.querySelector("#malgn-check-answer");h&&this.currentIndex<this.quizzes.length-1&&(h.style.display=""),d&&(d.style.display="none")}}}});var D=B(()=>{E();M();$();T();F();if(window.__malgnTutorLoaded)console.warn("[MalgnTutor] Already loaded, skipping.");else{let c=function(){let t=window.MalgnTutor;if(!t||!t.apiUrl){console.error("[MalgnTutor] window.MalgnTutor.apiUrl is required.");return}let e=t.mode==="inline";if(!document.querySelector('link[href*="bootstrap-icons"]')){let r=document.createElement("link");r.rel="stylesheet",r.href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css",document.head.appendChild(r)}let o=new y(t.apiUrl,t.apiKey);m.inject({mode:t.mode||"layer",container:t.container||null,title:t.title||"",videoIframeId:t.videoIframeId||"",width:t.width||380,height:t.height||650});let i=m.root,s=new k(i);s.init();let n=new S(o,i),a=new q(o,{contentIds:t.contentIds||[],courseId:t.courseId||0,courseUserId:t.courseUserId||0,lessonId:t.lessonId||0,userId:t.userId||0,settings:t.settings||{},parentSessionId:t.parentSessionId||0},i);if(a.init(),a.onSessionCreating=()=>{m.setFabLoading(!0)},a.onSessionCreated=r=>{m.setFabLoading(!1),r.learning&&s.renderLearningData(r.learning),r.session&&r.session.id&&n.loadQuizzes(r.session.id),r.messages&&r.messages.length>0&&(a.clearMessages(),r.messages.forEach(l=>{l.role==="user"?a.addUserMessage(l.content):a.addAssistantMessage(l.content)}))},a.onSessionLoaded=r=>{r.learning&&s.renderLearningData(r.learning),r.id&&n.loadQuizzes(r.id)},s.onQuestionClick=r=>{a.sendMessage(r)},t.sessionId&&a.loadSession(t.sessionId),!e){i.querySelector("#malgn-fab").addEventListener("click",()=>m.toggle());let r=i.querySelector("#malgn-close");r&&r.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),m.close()})}console.log(`[MalgnTutor] Initialized (${e?"inline":"layer"} mode, Shadow DOM).`)};window.__malgnTutorLoaded=!0,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c()}});D();})();
