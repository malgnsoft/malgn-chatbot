...
`});var x,B=f(()=>{L();x={chatbot:null,fab:null,root:null,isInline:!1,inject(h){let t=h.width||380,e=h.height||650;this.isInline=h.mode==="inline";let o=document.createElement("div");o.id="malgn-tutor-host",this.isInline&&(o.style.cssText="display:flex;flex-direction:column;width:100%;height:100%;overflow:hidden;");let a=o.attachShadow({mode:"open"});this.root=a;let c=document.createElement("style");c.textContent=T,a.appendChild(c);let i=document.createElement("link");if(i.rel="stylesheet",i.href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css",a.appendChild(i),!this.isInline){let n=document.createElement("button");n.id="malgn-fab",n.className="chat-fab",n.title="\uCC44\uD305 \uC5F4\uAE30",n.innerHTML=`
        <i class="bi bi-chat-dots-fill chat-fab-icon"></i>
        <i class="bi bi-x-lg chat-fab-close"></i>
      `,a.appendChild(n),this.fab=n}let s=document.createElement("div");if(s.id="malgn-chatbot",this.isInline?s.className="chatbot chatbot--inline":(s.className="chatbot",s.hidden=!0,s.style.width=t+"px",s.style.height=e+"px"),s.innerHTML=`
      <!-- Header -->
    ...
    `,a.appendChild(s),this.isInline&&h.container){let n=typeof h.container=="string"?document.querySelector(h.container):h.container;n?(n.textContent="",document.body.style.overflow="hidden",n.style.overflow="hidden",n.appendChild(o)):(console.error("[MalgnTutor] Container not found:",h.container),document.body.appendChild(o))}else document.body.appendChild(o);this.chatbot=s},open(){this.isInline||(this.chatbot&&(this.chatbot.hidden=!1),this.fab&&this.fab.classList.add("active"))},setFabLoading(h){this.fab&&(h?this.fab.classList.add("loading"):this.fab.classList.remove("loading"))},close(){this.isInline||(this.chatbot&&(this.chatbot.hidden=!0),this.fab&&this.fab.classList.remove("active"))},toggle(){this.isInline||(this.chatbot&&this.chatbot.hidden?this.open():this.close())}}});function b(h){let t=document.createElement("div");return t.textContent=h,t.innerHTML}function q(h){if(!h)return"";let t=[],e=h;e=e.replace(/\$\$([\s\S]*?)\$\$/g,r=>{let l=t.length;return t.push(r),`\0MATH${l}\0`}),e=e.replace(/\\\[([\s\S]*?)\\\]/g,r=>{let l=t.length;return t.push(r),`\0MATH${l}\0`}),e=e.replace(/\\\((.+?)\\\)/g,r=>{let l=t.length;return t.push(r),`\0MATH${l}\0`});let o=[];e=e.replace(/```(\w*)\n?([\s\S]*?)```/g,(r,l,p)=>{let m=o.length;return o.push(`<pre class="chatbot-code-block"><code>${b(p.trim())}</code></pre>`),`\0CODEBLOCK${m}\0`});let a=[];e=e.replace(/`([^`]+)`/g,(r,l)=>{let p=a.length;return a.push(`<code class="chatbot-inline-code">${b(l)}</code>`),`\0INLINE${p}\0`});let c=e.split(`
`),i=[],s=!1,n=null;for(let r=0;r<c.length;r++){let l=c[r];if(l.includes("\0CODEBLOCK")){s&&(i.push(n==="ol"?"</ol>":"</ul>"),s=!1),i.push(l);continue}if(/^(-{3,}|\*{3,}|_{3,})\s*$/.test(l.trim())){s&&(i.push(n==="ol"?"</ol>":"</ul>"),s=!1),i.push('<hr class="chatbot-hr">');continue}let p=l.match(/^(#{1,4})\s+(.+)$/);if(p){s&&(i.push(n==="ol"?"</ol>":"</ul>"),s=!1);let u=p[1].length;i.push(`<strong class="chatbot-h chatbot-h${u}">${k(b(p[2]))}</strong>`);continue}let m=l.match(/^(\d+)[.)]\s+(.+)$/);if(m){(!s||n!=="ol")&&(s&&i.push(n==="ol"?"</ol>":"</ul>"),i.push('<ol class="chatbot-list">'),s=!0,n="ol"),i.push(`<li>${k(b(m[2]))}</li>`);continue}let v=l.match(/^[\-\*•]\s+(.+)$/);if(v){(!s||n!=="ul")&&(s&&i.push(n==="ol"?"</ol>":"</ul>"),i.push('<ul class="chatbot-list">'),s=!0,n="ul"),i.push(`<li>${k(b(v[1]))}</li>`);continue}if(s&&(i.push(n==="ol"?"</ol>":"</ul>"),s=!1),l.trim()===""){i.push("<br>");continue}i.push(`<span>${k(b(l))}</span>`)}s&&i.push(n==="ol"?"</ol>":"</ul>");let d=i.join(`
`);return o.forEach((r,l)=>{d=d.replace(`\0CODEBLOCK${l}\0`,r)}),a.forEach((r,l)=>{d=d.replace(`\0INLINE${l}\0`,r)}),t.forEach((r,l)=>{d=d.replace(`\0MATH${l}\0`,r)}),d}function A(h){let t=document.createElement("link");if(t.rel="stylesheet",t.href="https://cdn.jsdelivr.net/npm/katex@0.16.40/dist/katex.min.css",h.appendChild(t),C||F)return;F=!0;let e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/katex@0.16.40/dist/katex.min.js",e.onload=()=>{let o=document.createElement("script");o.src="https://cdn.jsdelivr.net/npm/katex@0.16.40/dist/contrib/auto-render.min.js",o.onload=()=>{C=!0,M.forEach(a=>a()),M.length=0},document.head.appendChild(o)},document.head.appendChild(e)}function g(h){C&&window.renderMathInElement?window.renderMathInElement(h,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"\\[",right:"\\]",display:!0},{left:"\\(",right:"\\)",display:!1}],throwOnError:!1}):M.push(()=>g(h))}function k(h){return h.replace(/\*{3}(.+?)\*{3}/g,"<strong><em>$1</em></strong>").replace(/\*{2}(.+?)\*{2}/g,"<strong>$1</strong>").replace(/__(.+?)__/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/(?<!\w)_(.+?)_(?!\w)/g,"<em>$1</em>")}var C,F,M,y=f(()=>{C=!1,F=!1,M=[]});var S,H=f(()=>{y();S=class{constructor(t,e,o){this.api=t,this.config=e,this.root=o,this.sessionId=null,this.isLoading=!1,this.onSessionCreating=null,this.onSessionCreated=null}init(){this.messagesEl=this.root.querySelector("#malgn-messages"),this.inputEl=this.root.querySelector("#malgn-input"),this.sendBtn=this.root.querySelector("#malgn-send"),this.sendBtn.addEventListener("click",()=>this.sendMessage()),this.inputEl.addEventListener("keydown",t=>{t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),this.sendMessage())}),this.inputEl.addEventListener("input",()=>this.autoResize()),this.inputEl.addEventListener("focus",()=>this.scrollToBottom())}autoResize(){this.inputEl.style.height="auto";let t=parseInt(getComputedStyle(this.inputEl).lineHeight)*5;this.inputEl.style.height=Math.min(this.inputEl.scrollHeight,t)+"px"}async loadSession(t){this.sessionId=t;try{let e=await this.api.getSession(t);e.success?(this.clearMessages(),(e.data.messages||[]).forEach(a=>{a.role==="user"?this.addUserMessage(a.content):this.addAssistantMessage(a.content)}),this.onSessionLoaded&&this.onSessionLoaded(e.data)):(console.warn("\uC138\uC158\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uC0C8 \uC138\uC158\uC73C\uB85C \uC2DC\uC791\uD569\uB2C8\uB2E4."),this.sessionId=null)}catch(e){console.error("\uC138\uC158 \uB85C\uB4DC \uC2E4\uD328:",e),this.sessionId=null}}clearMessages(){this.messagesEl.innerHTML=""}showSystemMessage(t){let e=document.createElement("div");e.className="chatbot-system-message",e.style.cssText=`
    ...
    `;if(c)e.options.forEach((r,l)=>{let p=l+1,m=this.answers[e.id]===String(p);i+=`
          <div class="chatbot-quiz-option ${m?"selected":""}" data-quiz-id="${e.id}" data-answer="${p}">
            <span class="chatbot-option-num">${p}</span>
            <span>${b(r)}</span>
          </div>
        `});else{let r=this.answers[e.id]==="O",l=this.answers[e.id]==="X";i+=`
        <div class="chatbot-quiz-ox-options">
          <div class="chatbot-quiz-option chatbot-quiz-ox ${r?"selected":""}" data-quiz-id="${e.id}" data-answer="O">O</div>
    ...
    `,t.innerHTML=i,g(t),t.querySelectorAll(".chatbot-quiz-option").forEach(r=>{r.addEventListener("click",()=>{this.answers[r.dataset.quizId]=r.dataset.answer,this.renderCurrentQuiz()})});let s=this.root.querySelector("#malgn-prev-quiz"),n=this.root.querySelector("#malgn-next-quiz"),d=this.root.querySelector("#malgn-check-answer");s&&s.addEventListener("click",()=>this.prev()),n&&n.addEventListener("click",()=>this.next()),d&&d.addEventListener("click",()=>this.checkAnswer()),this.checked[e.id]&&this.showResult(e)}prev(){this.currentIndex>0&&(this.currentIndex--,this.renderCurrentQuiz())}next(){this.currentIndex<this.quizzes.length-1&&(this.currentIndex++,this.renderCurrentQuiz())}checkAnswer(){let t=this.quizzes[this.currentIndex],e=this.answers[t.id],o=this.root.querySelector("#malgn-quiz-result");if(!o)return;if(!e){o.className="chatbot-quiz-result",o.innerHTML='<span class="text-warning">\uB2F5\uC744 \uC120\uD0DD\uD574 \uC8FC\uC138\uC694.</span>',o.style.display="block";return}this.attempts[t.id]=(this.attempts[t.id]||0)+1;let a=this.attempts[t.id],c=e===t.answer;if(this.showResult(t,c,a),c||a>=2){this.checked[t.id]=!0;let i=this.root.querySelector("#malgn-next-quiz"),s=this.root.querySelector("#malgn-check-answer");i&&this.currentIndex<this.quizzes.length-1&&(i.style.display=""),s&&(s.style.display="none")}}showResult(t,e,o){let a=this.root.querySelector("#malgn-quiz-result");if(!a)return;e===void 0&&(e=this.answers[t.id]===t.answer,o=this.attempts[t.id]||1);let c=e?"chatbot-result-correct":"chatbot-result-wrong",i=e?"bi-check-circle-fill":"bi-x-circle-fill",s=e?"\uC815\uB2F5\uC785\uB2C8\uB2E4.":"\uC624\uB2F5\uC785\uB2C8\uB2E4.";a.className=`chatbot-quiz-result ${e?"correct":"wrong"}`;let n=`
      <div class="${c}">
        <i class="bi ${i} chatbot-result-icon"></i>${s}
      </div>
    `;!e&&o===1&&(n+='<div class="chatbot-result-explanation">\uB2E4\uC2DC \uD55C \uBC88 \uB3C4\uC804\uD574 \uBCF4\uC138\uC694!</div>'),(e||o>=2)&&t.explanation&&(n+=`<div class="chatbot-result-explanation"><strong>\uD574\uC124:</strong> ${b(t.explanation)}</div>`),a.innerHTML=n,g(a),a.style.display="block"}}});var _=U(()=>{$();B();H();D();j();y();if(window.__malgnTutorLoaded)console.warn("[MalgnTutor] Already loaded, skipping.");else{let h=function(){let t=window.MalgnTutor;if(!t||!t.apiUrl){console.error("[MalgnTutor] window.MalgnTutor.apiUrl is required.");return}let e=t.mode==="inline";if(!document.querySelector('link[href*="bootstrap-icons"]')){let r=document.createElement("link");r.rel="stylesheet",r.href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css",document.head.appendChild(r)}let o=new z(t.apiUrl,t.apiKey,t.siteId||1);x.inject({mode:t.mode||"layer",container:t.container||null,title:t.title||"",videoIframeId:t.videoIframeId||"",width:t.width||380,height:t.height||650});let a=x.root;A(a);let c=new I(a);c.init();let i=new E(o,a),s=t.welcomeMessage||"",n=new S(o,{contentIds:t.contentIds||[],chatContentIds:t.chatContentIds||[],courseId:t.courseId||0,courseUserId:t.courseUserId||0,lessonId:t.lessonId||0,userId:t.userId||0,settings:t.settings||{},parentSessionId:t.parentSessionId||0},a);if(n.init(),n.onSessionCreating=()=>{x.setFabLoading(!0),n.showSystemMessage("AI \uD559\uC2B5 \uC138\uC158\uC744 \uC0DD\uC131\uC911\uC785\uB2C8\uB2E4. \uC7A0\uC2DC\uB9CC \uAE30\uB2E4\uB824\uC8FC\uC138\uC694...")},n.onSessionCreated=r=>{x.setFabLoading(!1),n.removeSystemMessage(),r.learning&&c.renderLearningData(r.learning),r.session&&r.session.id&&i.loadQuizzes(r.session.id),r.messages&&r.messages.length>0&&(n.clearMessages(),r.messages.forEach(l=>{l.role==="user"?n.addUserMessage(l.content):n.addAssistantMessage(l.content)})),s&&n.messagesEl.children.length===0&&n.addAssistantMessage(s)},n.onSessionLoaded=r=>{r.learning&&c.renderLearningData(r.learning),r.id&&i.loadQuizzes(r.id),s&&n.messagesEl.children.length===0&&n.addAssistantMessage(s)},c.onQuestionClick=r=>{n.sendMessage(r)},t.sessionId?n.loadSession(t.sessionId):(t.parentSessionId||t.contentIds&&t.contentIds.length>0)&&n.ensureSession(),!e){a.querySelector("#malgn-fab").addEventListener("click",()=>x.toggle());let r=a.querySelector("#malgn-close");r&&r.addEventListener("click",l=>{l.preventDefault(),l.stopPropagation(),x.close()})}let d=a.querySelector("#malgn-reset");d&&d.addEventListener("click",async()=>{if(confirm("\uB300\uD654 \uB0B4\uC6A9\uC744 \uBAA8\uB450 \uC0AD\uC81C\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?")){if(n.sessionId)try{await o.clearMessages(n.sessionId)}catch(r){console.error("[MalgnTutor] \uBA54\uC2DC\uC9C0 \uCD08\uAE30\uD654 \uC2E4\uD328:",r)}n.clearMessages(),s&&n.addAssistantMessage(s)}}),console.log(`[MalgnTutor] Initialized (${e?"inline":"layer"} mode, Shadow DOM).`)};window.__malgnTutorLoaded=!0,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",h):h()}});_();})();
