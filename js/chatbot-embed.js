(()=>{var f=(h,t)=>()=>(h&&(t=h(h=0)),t);var U=(h,t)=>()=>(t||h((t={exports:{}}).exports,t),t.exports);var z,$=f(()=>{z=class{constructor(t,e,o=0){this.baseUrl=t,this.apiKey=e,this.siteId=o}getHeaders(t=!0){let e={};return this.apiKey&&(e.Authorization=`Bearer ${this.apiKey}`),this.siteId&&(e["X-Site-Id"]=String(this.siteId)),t&&(e["Content-Type"]="application/json"),e}async handleResponse(t){if(t.status===401)throw new Error("API Key\uAC00 \uC720\uD6A8\uD558\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.");if(!t.ok){let e=await t.json().catch(()=>({}));throw new Error(e.error?.message||"\uC694\uCCAD \uC2E4\uD328")}return t.json()}async createSession(t,e={}){let o={content_ids:t};e.courseId&&(o.course_id=e.courseId),e.courseUserId&&(o.course_user_id=e.courseUserId),e.lessonId&&(o.lesson_id=e.lessonId),e.userId&&(o.user_id=e.userId),e.settings&&(o.settings=e.settings),e.parentSessionId&&(o.parent_id=e.parentSessionId),e.chatContentIds&&e.chatContentIds.length>0&&(o.chat_content_ids=e.chatContentIds);let s=await fetch(`${this.baseUrl}/sessions`,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(o)});return this.handleResponse(s)}async getSession(t){let e=await fetch(`${this.baseUrl}/sessions/${t}`,{headers:this.getHeaders(!1)});return this.handleResponse(e)}async sendMessage(t,e,o={}){let s=await fetch(`${this.baseUrl}/chat`,{method:"POST",headers:this.getHeaders(),body:JSON.stringify({message:t,sessionId:e,settings:o})});return this.handleResponse(s)}async sendMessageStream(t,e,o={},s,c,i){try{let n=await fetch(`${this.baseUrl}/chat/stream`,{method:"POST",headers:this.getHeaders(),body:JSON.stringify({message:t,sessionId:e,settings:o})});if(!n.ok){let r=await n.json().catch(()=>({}));i&&i(new Error(r.error?.message||"\uC2A4\uD2B8\uB9AC\uBC0D \uC694\uCCAD \uC2E4\uD328"));return}let a=n.body.pipeThrough(new TextDecoderStream).getReader(),d="",l="";for(;;){let{done:r,value:b}=await a.read();if(r)break;d+=b;let g=d.split(`
`);d=g.pop()||"";for(let v of g){let u=v.trim();if(u){if(u.startsWith("event: "))l=u.slice(7);else if(u.startsWith("data: "))try{let w=JSON.parse(u.slice(6));l==="token"&&w.response&&s?s(w.response):l==="done"&&c?c(w):l==="error"&&i&&i(new Error(w.message))}catch{}}}}}catch(n){i&&i(n)}}async clearMessages(t){let e=await fetch(`${this.baseUrl}/sessions/${t}/messages`,{method:"DELETE",headers:this.getHeaders(!1)});return this.handleResponse(e)}async getQuizzes(t){let e=await fetch(`${this.baseUrl}/sessions/${t}/quizzes`,{headers:this.getHeaders(!1)});return this.handleResponse(e)}}});var T,L=f(()=>{T=`/* ============================================
...
`});var x,B=f(()=>{L();x={chatbot:null,fab:null,root:null,isInline:!1,inject(h){let t=h.width||380,e=h.height||650;this.isInline=h.mode==="inline";let o=document.createElement("div");o.id="malgn-tutor-host",this.isInline&&(o.style.cssText="display:flex;flex-direction:column;width:100%;height:100%;overflow:hidden;");let s=o.attachShadow({mode:"open"});this.root=s;let c=document.createElement("style");c.textContent=T,s.appendChild(c);let i=document.createElement("link");if(i.rel="stylesheet",i.href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css",s.appendChild(i),!this.isInline){let a=document.createElement("button");a.id="malgn-fab",a.className="chat-fab",a.title="\uCC44\uD305 \uC5F4\uAE30",a.innerHTML=`
        <i class="bi bi-chat-dots-fill chat-fab-icon"></i>
        <i class="bi bi-x-lg chat-fab-close"></i>
      `,s.appendChild(a),this.fab=a}let n=document.createElement("div");if(n.id="malgn-chatbot",this.isInline?n.className="chatbot chatbot--inline":(n.className="chatbot",n.hidden=!0,n.style.width=t+"px",n.style.height=e+"px"),n.innerHTML=`
      <!-- Header -->
    ...
    `,s.appendChild(n),this.isInline&&h.container){let a=typeof h.container=="string"?document.querySelector(h.container):h.container;a?(a.textContent="",document.body.style.overflow="hidden",a.style.overflow="hidden",a.appendChild(o)):(console.error("[MalgnTutor] Container not found:",h.container),document.body.appendChild(o))}else document.body.appendChild(o);this.chatbot=n},open(){this.isInline||(this.chatbot&&(this.chatbot.hidden=!1),this.fab&&this.fab.classList.add("active"))},setFabLoading(h){this.fab&&(h?this.fab.classList.add("loading"):this.fab.classList.remove("loading"))},close(){this.isInline||(this.chatbot&&(this.chatbot.hidden=!0),this.fab&&this.fab.classList.remove("active"))},toggle(){this.isInline||(this.chatbot&&this.chatbot.hidden?this.open():this.close())}}});function p(h){let t=document.createElement("div");return t.textContent=h,t.innerHTML}function q(h){if(!h)return"";let t=[],e=h;e=e.replace(/\$\$([\s\S]*?)\$\$/g,l=>{let r=t.length;return t.push(l),`\0MATH${r}\0`}),e=e.replace(/\\\[([\s\S]*?)\\\]/g,l=>{let r=t.length;return t.push(l),`\0MATH${r}\0`}),e=e.replace(/\\\((.+?)\\\)/g,l=>{let r=t.length;return t.push(l),`\0MATH${r}\0`});let o=[];e=e.replace(/```(\w*)\n?([\s\S]*?)```/g,(l,r,b)=>{let g=o.length;return o.push(`<pre class="chatbot-code-block"><code>${p(b.trim())}</code></pre>`),`\0CODEBLOCK${g}\0`});let s=[];e=e.replace(/`([^`]+)`/g,(l,r)=>{let b=s.length;return s.push(`<code class="chatbot-inline-code">${p(r)}</code>`),`\0INLINE${b}\0`});let c=e.split(`
`),i=[],n=!1,a=null;for(let l=0;l<c.length;l++){let r=c[l];if(r.includes("\0CODEBLOCK")){n&&(i.push(a==="ol"?"</ol>":"</ul>"),n=!1),i.push(r);continue}if(/^(-{3,}|\*{3,}|_{3,})\s*$/.test(r.trim())){n&&(i.push(a==="ol"?"</ol>":"</ul>"),n=!1),i.push('<hr class="chatbot-hr">');continue}let b=r.match(/^(#{1,4})\s+(.+)$/);if(b){n&&(i.push(a==="ol"?"</ol>":"</ul>"),n=!1);let u=b[1].length;i.push(`<strong class="chatbot-h chatbot-h${u}">${k(p(b[2]))}</strong>`);continue}let g=r.match(/^(\d+)[.)]\s+(.+)$/);if(g){(!n||a!=="ol")&&(n&&i.push(a==="ol"?"</ol>":"</ul>"),i.push('<ol class="chatbot-list">'),n=!0,a="ol"),i.push(`<li>${k(p(g[2]))}</li>`);continue}let v=r.match(/^[\-\*•]\s+(.+)$/);if(v){(!n||a!=="ul")&&(n&&i.push(a==="ol"?"</ol>":"</ul>"),i.push('<ul class="chatbot-list">'),n=!0,a="ul"),i.push(`<li>${k(p(v[1]))}</li>`);continue}if(n&&(i.push(a==="ol"?"</ol>":"</ul>"),n=!1),r.trim()===""){i.push("<br>");continue}i.push(`<span>${k(p(r))}</span>`)}n&&i.push(a==="ol"?"</ol>":"</ul>");let d=i.join(`
`);return o.forEach((l,r)=>{d=d.replace(`\0CODEBLOCK${r}\0`,l)}),s.forEach((l,r)=>{d=d.replace(`\0INLINE${r}\0`,l)}),t.forEach((l,r)=>{d=d.replace(`\0MATH${r}\0`,l)}),d}function A(h){let t=document.createElement("link");if(t.rel="stylesheet",t.href="https://cdn.jsdelivr.net/npm/katex@0.16.40/dist/katex.min.css",h.appendChild(t),C||F)return;F=!0;let e=document.createElement("script");e.src="https://cdn.jsdelivr.net/npm/katex@0.16.40/dist/katex.min.js",e.onload=()=>{let o=document.createElement("script");o.src="https://cdn.jsdelivr.net/npm/katex@0.16.40/dist/contrib/auto-render.min.js",o.onload=()=>{C=!0,M.forEach(s=>s()),M.length=0},document.head.appendChild(o)},document.head.appendChild(e)}function m(h){C&&window.renderMathInElement?window.renderMathInElement(h,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"\\[",right:"\\]",display:!0},{left:"\\(",right:"\\)",display:!1}],throwOnError:!1}):M.push(()=>m(h))}function k(h){return h.replace(/\*{3}(.+?)\*{3}/g,"<strong><em>$1</em></strong>").replace(/\*{2}(.+?)\*{2}/g,"<strong>$1</strong>").replace(/__(.+?)__/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/(?<!\w)_(.+?)_(?!\w)/g,"<em>$1</em>")}var C,F,M,y=f(()=>{C=!1,F=!1,M=[]});var S,H=f(()=>{y();S=class{constructor(t,e,o){this.api=t,this.config=e,this.root=o,this.sessionId=null,this.isLoading=!1,this.onSessionCreating=null,this.onSessionCreated=null}init(){this.messagesEl=this.root.querySelector("#malgn-messages"),this.inputEl=this.root.querySelector("#malgn-input"),this.sendBtn=this.root.querySelector("#malgn-send"),this.sendBtn.addEventListener("click",()=>this.sendMessage()),this.inputEl.addEventListener("keydown",t=>{t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),this.sendMessage())}),this.inputEl.addEventListener("input",()=>this.autoResize()),this.inputEl.addEventListener("focus",()=>this.scrollToBottom())}autoResize(){this.inputEl.style.height="auto";let t=parseInt(getComputedStyle(this.inputEl).lineHeight)*5;this.inputEl.style.height=Math.min(this.inputEl.scrollHeight,t)+"px"}async loadSession(t){this.sessionId=t;try{let e=await this.api.getSession(t);e.success?(this.clearMessages(),(e.data.messages||[]).forEach(s=>{s.role==="user"?this.addUserMessage(s.content):this.addAssistantMessage(s.content)}),this.onSessionLoaded&&this.onSessionLoaded(e.data)):(console.warn("\uC138\uC158\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. \uC0C8 \uC138\uC158\uC73C\uB85C \uC2DC\uC791\uD569\uB2C8\uB2E4."),this.sessionId=null)}catch(e){console.error("\uC138\uC158 \uB85C\uB4DC \uC2E4\uD328:",e),this.sessionId=null}}clearMessages(){this.messagesEl.innerHTML=""}showSystemMessage(t){let e=document.createElement("div");e.className="chatbot-system-message",e.style.cssText=`
    ...
    `,this.messagesEl.style.position="relative",this.messagesEl.appendChild(e)}removeSystemMessage(){let t=this.messagesEl.querySelector(".chatbot-system-message");t&&t.remove()}async ensureSession(){if(this.sessionId)return this.sessionId;this.onSessionCreating&&this.onSessionCreating();let t=await this.api.createSession(this.config.contentIds||[],{courseId:this.config.courseId,courseUserId:this.config.courseUserId,lessonId:this.config.lessonId,userId:this.config.userId,settings:this.config.settings,parentSessionId:this.config.parentSessionId,chatContentIds:this.config.chatContentIds});return t.success||console.error("\uC138\uC158 \uC0DD\uC131 \uC2E4\uD328:",t.error),t.success&&(this.sessionId=t.data.session.id,this.onSessionCreated&&this.onSessionCreated(t.data)),this.sessionId}async sendMessage(t){let e=t||this.inputEl.value.trim();if(!(!e||this.isLoading)){this.inputEl.value="",this.inputEl.style.height="auto",this.addUserMessage(e),this.setLoading(!0);try{await this.ensureSession();let o=document.createElement("div");o.className="chatbot-msg chatbot-msg--assistant chatbot-msg--typing";let s=document.createElement("div");s.className="chatbot-msg-content",s.innerHTML='<span class="chatbot-typing-dot"></span><span class="chatbot-typing-dot"></span><span class="chatbot-typing-dot"></span>',o.appendChild(s),this.messagesEl.appendChild(o),this.scrollToBottom();let c="",i=!1;await this.api.sendMessageStream(e,this.sessionId,this.config.settings||{},n=>{i||(i=!0,o.classList.remove("chatbot-msg--typing"),s.textContent=""),c+=n,s.textContent=c,this.scrollToBottom()},n=>{let a=n&&n.sanitizedResponse?n.sanitizedResponse:c;s.innerHTML=q(a),m(s),this.scrollToBottom(),this.setLoading(!1)},n=>{console.error("\uC2A4\uD2B8\uB9AC\uBC0D \uC2E4\uD328:",n),i||(s.textContent=""),s.innerHTML=q(c||"\uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4: "+n.message),this.setLoading(!1)})}catch(o){console.error("\uBA54\uC2DC\uC9C0 \uC804\uC1A1 \uC2E4\uD328:",o),this.addAssistantMessage("\uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4: "+o.message),this.setLoading(!1)}}}addUserMessage(t){let e=document.createElement("div");e.className="chatbot-msg chatbot-msg--user",e.innerHTML=`<div class="chatbot-msg-content">${p(t).replace(/\n/g,"<br>")}</div>`,this.messagesEl.appendChild(e),this.scrollToBottom()}addAssistantMessage(t){let e=document.createElement("div");e.className="chatbot-msg chatbot-msg--assistant",e.innerHTML=`<div class="chatbot-msg-content">${q(t)}</div>`,this.messagesEl.appendChild(e),m(e),this.scrollToBottom()}addTypingIndicator(){if(this.root.querySelector("#malgn-typing"))return;let t=document.createElement("div");t.id="malgn-typing",t.className="chatbot-msg chatbot-msg--assistant chatbot-msg--typing",t.innerHTML=`
      <div class="chatbot-msg-content">
        <span class="chatbot-typing-dot"></span>
        <span class="chatbot-typing-dot"></span>
        <span class="chatbot-typing-dot"></span>
      </div>
    `,this.messagesEl.appendChild(t),this.scrollToBottom()}removeTypingIndicator(){let t=this.root.querySelector("#malgn-typing");t&&t.remove()}setLoading(t){this.isLoading=t,this.sendBtn.disabled=t,this.inputEl.disabled=t,t||this.inputEl.focus()}scrollToBottom(){requestAnimationFrame(()=>{let t=this.root.querySelector("#malgn-body");t&&(t.scrollTop=t.scrollHeight)})}}});var E,D=f(()=>{y();E=class{constructor(t){this.root=t,this.onQuestionClick=null}init(){this.root.querySelectorAll("#malgn-chatbot .chatbot-tab").forEach(e=>{e.addEventListener("click",()=>this.switchTab(e.dataset.tab))})}switchTab(t){let e=this.root.querySelectorAll("#malgn-chatbot .chatbot-tab"),o=this.root.querySelectorAll("#malgn-chatbot .malgn-tab-content");e.forEach(d=>d.classList.remove("active")),o.forEach(d=>d.classList.remove("active"));let s=this.root.querySelector(`#malgn-chatbot .chatbot-tab[data-tab="${t}"]`),c=this.root.querySelector(`#malgn-tab-${t}`);s&&s.classList.add("active"),c&&c.classList.add("active");let i=this.root.querySelector("#malgn-messages"),n=this.root.querySelector(".chatbot-footer");t==="quiz"?(i&&(i.style.display="none"),n&&(n.style.display="none")):(i&&(i.style.display=""),n&&(n.style.display=""));let a=this.root.querySelector("#malgn-body");a&&(a.scrollTop=0)}renderLearningData(t){let e=this.root.querySelector("#malgn-goals-text");e&&(e.textContent=t.goal||"\uD559\uC2B5 \uBAA9\uD45C\uAC00 \uC124\uC815\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.");let o=this.root.querySelector("#malgn-summary-text");if(o){let c=t.summary;Array.isArray(c)&&c.length>0?o.innerHTML=c.map((i,n)=>`<div class="chatbot-summary-item">
            <span class="chatbot-badge">${n+1}</span>${p(i)}
          </div>`).join(""):c?o.textContent=c:o.textContent="\uC694\uC57D\uC774 \uC0DD\uC131\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4."}let s=this.root.querySelector("#malgn-recommend-text");if(s){let c=t.recommendedQuestions||[];c.length>0?(s.innerHTML=c.map((i,n)=>{let a=typeof i=="string"?i:i.question||"",d=typeof i=="object"&&i.answer||"";return`<div class="chatbot-recommend-item">
            <div class="chatbot-recommend-question" data-question="${p(a)}">
              <span class="chatbot-badge chatbot-badge-primary">${n+1}</span>
              <span class="chatbot-recommend-q-text">${p(a)}</span>
              ${d?'<span class="chatbot-recommend-toggle">\u25B2</span>':""}
            </div>
            ${d?`<div class="chatbot-recommend-answer" style="display:block;">
              <span class="chatbot-recommend-a-label">A.</span> ${p(d)}
            </div>`:""}
          </div>`}).join(""),s.querySelectorAll(".chatbot-recommend-question").forEach(i=>{i.addEventListener("click",()=>{let a=i.closest(".chatbot-recommend-item")?.querySelector(".chatbot-recommend-answer"),d=i.querySelector(".chatbot-recommend-toggle");if(a){let l=a.style.display!=="none";a.style.display=l?"none":"block",d&&(d.textContent=l?"\u25BC":"\u25B2")}else if(this.onQuestionClick){let l=i.dataset.question;l&&this.onQuestionClick(l)}})}),m(s)):s.textContent="\uCD94\uCC9C \uC9C8\uBB38\uC774 \uC0DD\uC131\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4."}e&&m(e),o&&m(o)}clearLearningData(){let t=this.root.querySelector("#malgn-goals-text"),e=this.root.querySelector("#malgn-summary-text"),o=this.root.querySelector("#malgn-recommend-text"),s=this.root.querySelector("#malgn-quiz-text");t&&(t.textContent="\uD559\uC2B5 \uBAA9\uD45C\uAC00 \uC124\uC815\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4."),e&&(e.textContent="\uC694\uC57D\uC774 \uC0DD\uC131\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4."),o&&(o.textContent="\uCD94\uCC9C \uC9C8\uBB38\uC774 \uC0DD\uC131\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4."),s&&(s.textContent="\uD034\uC988\uAC00 \uC0DD\uC131\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4.")}}});var I,j=f(()=>{y();I=class{constructor(t,e){this.api=t,this.root=e,this.quizzes=[],this.currentIndex=0,this.answers={},this.checked={},this.attempts={}}async loadQuizzes(t){let e=this.root.querySelector("#malgn-quiz-text");if(e)try{let o=await this.api.getQuizzes(t);o.success&&o.data.quizzes&&o.data.quizzes.length>0?(this.quizzes=o.data.quizzes,this.currentIndex=0,this.answers={},this.checked={},this.attempts={},this.renderCurrentQuiz()):e.textContent="\uD034\uC988\uAC00 \uC0DD\uC131\uB418\uC9C0 \uC54A\uC558\uC2B5\uB2C8\uB2E4."}catch(o){console.error("\uD034\uC988 \uB85C\uB4DC \uC2E4\uD328:",o),e.textContent="\uD034\uC988\uB97C \uBD88\uB7EC\uC62C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."}}renderCurrentQuiz(){let t=this.root.querySelector("#malgn-quiz-text");if(!t||this.quizzes.length===0)return;let e=this.quizzes[this.currentIndex],o=this.quizzes.length,s=this.currentIndex+1,c=e.quizType==="choice",i=`
      <div class="chatbot-quiz">
        ...
        <div class="chatbot-quiz-question">
          <strong>Q${s}.</strong> ${p(e.question)}
        </div>
        <div class="chatbot-quiz-options">
    `;if(c)e.options.forEach((l,r)=>{let b=r+1,g=this.answers[e.id]===String(b);i+=`
          <div class="chatbot-quiz-option ${g?"selected":""}" data-quiz-id="${e.id}" data-answer="${b}">
            <span class="chatbot-option-num">${b}</span>
            <span>${p(l)}</span>
          </div>
        `});else{let l=this.answers[e.id]==="O",r=this.answers[e.id]==="X";i+=`
        <div class="chatbot-quiz-ox-options">
          ...
          <div class="chatbot-quiz-option chatbot-quiz-ox ${r?"selected":""}" data-quiz-id="${e.id}" data-answer="X">X</div>
        </div>
      `}i+=`
        </div>
    ...
    `,t.innerHTML=i,m(t),t.querySelectorAll(".chatbot-quiz-option").forEach(l=>{l.addEventListener("click",()=>{this.answers[l.dataset.quizId]=l.dataset.answer,this.renderCurrentQuiz()})});let n=this.root.querySelector("#malgn-prev-quiz"),a=this.root.querySelector("#malgn-next-quiz"),d=this.root.querySelector("#malgn-check-answer");n&&n.addEventListener("click",()=>this.prev()),a&&a.addEventListener("click",()=>this.next()),d&&d.addEventListener("click",()=>this.checkAnswer()),this.checked[e.id]&&this.showResult(e)}prev(){this.currentIndex>0&&(this.currentIndex--,this.renderCurrentQuiz())}next(){this.currentIndex<this.quizzes.length-1&&(this.currentIndex++,this.renderCurrentQuiz())}checkAnswer(){let t=this.quizzes[this.currentIndex],e=this.answers[t.id],o=this.root.querySelector("#malgn-quiz-result");if(!o)return;if(!e){o.className="chatbot-quiz-result",o.innerHTML='<span class="text-warning">\uB2F5\uC744 \uC120\uD0DD\uD574 \uC8FC\uC138\uC694.</span>',o.style.display="block";return}this.attempts[t.id]=(this.attempts[t.id]||0)+1;let s=this.attempts[t.id],c=e===t.answer;if(this.showResult(t,c,s),c||s>=2){this.checked[t.id]=!0;let i=this.root.querySelector("#malgn-next-quiz"),n=this.root.querySelector("#malgn-check-answer");i&&this.currentIndex<this.quizzes.length-1&&(i.style.display=""),n&&(n.style.display="none")}}showResult(t,e,o){let s=this.root.querySelector("#malgn-quiz-result");if(!s)return;e===void 0&&(e=this.answers[t.id]===t.answer,o=this.attempts[t.id]||1);let c=e?"chatbot-result-correct":"chatbot-result-wrong",i=e?"bi-check-circle-fill":"bi-x-circle-fill",n=e?"\uC815\uB2F5\uC785\uB2C8\uB2E4.":"\uC624\uB2F5\uC785\uB2C8\uB2E4.";s.className=`chatbot-quiz-result ${e?"correct":"wrong"}`;let a=`
      <div class="${c}">
        <i class="bi ${i} chatbot-result-icon"></i>${n}
      </div>
    `;!e&&o===1&&(a+='<div class="chatbot-result-explanation">\uB2E4\uC2DC \uD55C \uBC88 \uB3C4\uC804\uD574 \uBCF4\uC138\uC694!</div>'),(e||o>=2)&&t.explanation&&(a+=`<div class="chatbot-result-explanation"><strong>\uD574\uC124:</strong> ${p(t.explanation)}</div>`),s.innerHTML=a,m(s),s.style.display="block"}}});var _=U(()=>{$();B();H();D();j();y();if(window.__malgnTutorLoaded)console.warn("[MalgnTutor] Already loaded, skipping.");else{let h=function(){let t=window.MalgnTutor;if(!t||!t.apiUrl){console.error("[MalgnTutor] window.MalgnTutor.apiUrl is required.");return}let e=t.mode==="inline";if(!document.querySelector('link[href*="bootstrap-icons"]')){let r=document.createElement("link");r.rel="stylesheet",r.href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css",document.head.appendChild(r)}let o=new z(t.apiUrl,t.apiKey,t.siteId||1);x.inject({mode:t.mode||"layer",container:t.container||null,title:t.title||"",videoIframeId:t.videoIframeId||"",width:t.width||380,height:t.height||650});let s=x.root;A(s);let c=new E(s);c.init();let i=new I(o,s),n=t.welcomeMessage||"",a=new S(o,{contentIds:t.contentIds||[],chatContentIds:t.chatContentIds||[],courseId:t.courseId||0,courseUserId:t.courseUserId||0,lessonId:t.lessonId||0,userId:t.userId||0,settings:t.settings||{},parentSessionId:t.parentSessionId||0},s);if(a.init(),a.onSessionCreating=()=>{x.setFabLoading(!0),a.showSystemMessage("AI \uD559\uC2B5 \uC138\uC158\uC744 \uC0DD\uC131\uC911\uC785\uB2C8\uB2E4. \uC7A0\uC2DC\uB9CC \uAE30\uB2E4\uB824\uC8FC\uC138\uC694...")},a.onSessionCreated=r=>{x.setFabLoading(!1),a.removeSystemMessage(),r.learning&&c.renderLearningData(r.learning),r.session&&r.session.id&&i.loadQuizzes(r.session.id),r.messages&&r.messages.length>0&&(a.clearMessages(),r.messages.forEach(b=>{b.role==="user"?a.addUserMessage(b.content):a.addAssistantMessage(b.content)})),n&&a.messagesEl.children.length===0&&a.addAssistantMessage(n)},a.onSessionLoaded=r=>{r.learning&&c.renderLearningData(r.learning),r.id&&i.loadQuizzes(r.id),n&&a.messagesEl.children.length===0&&a.addAssistantMessage(n)},c.onQuestionClick=r=>{a.sendMessage(r)},t.parentSessionId&&t.courseUserId?a.ensureSession():t.sessionId?a.loadSession(t.sessionId).then(()=>{!a.sessionId&&(t.parentSessionId||t.contentIds&&t.contentIds.length>0)&&a.ensureSession()}):(t.parentSessionId||t.contentIds&&t.contentIds.length>0)&&a.ensureSession(),!e){s.querySelector("#malgn-fab").addEventListener("click",()=>x.toggle());let r=s.querySelector("#malgn-close");r&&r.addEventListener("click",b=>{b.preventDefault(),b.stopPropagation(),x.close()})}let l=s.querySelector("#malgn-reset");l&&l.addEventListener("click",async()=>{if(confirm("\uB300\uD654 \uB0B4\uC6A9\uC744 \uBAA8\uB450 \uC0AD\uC81C\uD558\uC2DC\uACA0\uC2B5\uB2C8\uAE4C?")){if(a.sessionId)try{await o.clearMessages(a.sessionId)}catch(r){console.error("[MalgnTutor] \uBA54\uC2DC\uC9C0 \uCD08\uAE30\uD654 \uC2E4\uD328:",r)}a.clearMessages(),n&&a.addAssistantMessage(n)}}),console.log(`[MalgnTutor] Initialized (${e?"inline":"layer"} mode, Shadow DOM).`)};window.__malgnTutorLoaded=!0,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",h):h()}});_();})();
