...
`});var x,B=f(()=>{L();x={chatbot:null,fab:null,root:null,isInline:!1,inject(h){let t=h.width||380,e=h.height||650;this.isInline=h.mode==="inline";let o=document.createElement("div");o.id="malgn-tutor-host",this.isInline&&(o.style.cssText="display:flex;flex-direction:column;width:100%;height:100%;overflow:hidden;");let a=o.attachShadow({mode:"open"});this.root=a;let c=document.createElement("style");c.textContent=T,a.appendChild(c);let s=document.createElement("link");if(s.rel="stylesheet",s.href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css",a.appendChild(s),!this.isInline){let r=document.createElement("button");r.id="malgn-fab",r.className="chat-fab",r.title="\uCC44\uD305 \uC5F4\uAE30",r.innerHTML=`
